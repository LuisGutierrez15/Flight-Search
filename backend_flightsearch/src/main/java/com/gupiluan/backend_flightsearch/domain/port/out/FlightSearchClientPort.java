package com.gupiluan.backend_flightsearch.domain.port.out;
...
public interface FlightSearchClientPort {
    /**
     ...
     */
    List<FlightOffer> fetchFlights(FlightSearchCriteria flightSearchCriteria);
    ...
    /**
     * 
     * @param keyWord entire or partial name of the airport or city
     * @return a list of airports matching the search criteria
     */
    List<Airport> getAirportsByNameOrCode(String keyWord);
